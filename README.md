...
Go to Microsoft Store Online, click `Get in Store app`, and open the Microsoft Store pop-up. It will be automatically redirected. Once Microsoft Store has opened, click the install button.
--| --|
